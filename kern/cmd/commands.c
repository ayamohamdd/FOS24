...
struct Command commands[] =
{
		...
		{"loadall", "load all the programs", command_loadall, 0},
};
...
int command_loadall(int number_of_arguments, char **arguments)
{
	char* command_string = "";
	char* args[100];
	int num = 4;
...
//		cprintf("h1\n");
		...
		command_string = "load fact " ;
		char final1[100];
		char final2[100];
		char final3[100];
		char *whiteS = " ";
//		cprintf("111111\n");
		strcconcat(command_string, x, final1);
//		cprintf("s = %s \n");
//		cprintf("2222222\n");
		strcconcat(final1, whiteS, final2);
		ltostr((150 - i*10)%21, x);
		strcconcat(final2, x, final3);
//		cprintf("s = %s \n", final3);
		strsplit(final3, whiteS, args, &num) ;

		//		char* final;

//		cprintf("h7\n");

		commnad_load_env(4, args);//load fact 100 -20
//		cprintf("h8\n");
		args[1] = "fib";
//		cprintf("h9\n");
		commnad_load_env(4, args);//load fact 100 -20
