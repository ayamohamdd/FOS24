...
//	panic("process_command is not implemented yet");
	...
	/*Testing the str2lower*/
//	char lower[1000];
//	char* tmp;
//	tmp = str2lower(lower , arguments[0]);
//	cprintf("%s -> %s\n", arguments[0], tmp);
//===================================================================================================================
//===================================================================================================================
	LIST_INIT(&foundCommands);
	...
	for (int i = 0; i < NUM_OF_COMMANDS; i++) {
		 char* argcpy = arguments[0];
		 char* cmdcpy = commands[i].name;
		 int n = strlen(argcpy);
		 int m = strlen(cmdcpy);
		 if(n == m && strcmp(arguments[0], commands[i].name) == 0) {
			LIST_INIT(&foundCommands);
		...
		while(*argcpy && n < m) {
			if(strchr(cmdcpy, *argcpy) == NULL) break;
			cmdcpy = strchr(cmdcpy, *argcpy);
			argcpy++;
		}
	...
	return (isMatched? CMD_MATCHED : CMD_INVALID);
}
